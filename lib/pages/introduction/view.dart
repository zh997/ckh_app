                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20,),
                      Text('708090创客汇于2015年12月成立，提供联合办公空间及内地与香港商业咨询服务。截止2019年，708090创客汇在深圳及香港已有3个驻点，合作机构约30家，管理面积约5,000平方米。', style: TextStyle(color: AppColors.COLOR_2C3340, fontSize: AppFont.SIZE_28)),
                      SizedBox(height: 20,),
                      Text('作为深圳市龙岗区布吉街道首家“创新创业孵化基地”，本空间提供一站式的创业服务，通过为创业团队提供办公场地、会议空间、融资服务、营销推广、人力资源、法务财务、管理、媒体传播等服务，公益创业培训、以铸造业界领先的创客空间。本创客空间旨在为各位年轻有为、有梦想、有干劲的创业家提供帮助，透过共享空间、天使投资、创业指导、业务交流等，致力让创业家相信创业不再是一个困难，并且成功实现梦想。', style: TextStyle(color: AppColors.COLOR_2C3340, fontSize: AppFont.SIZE_28)),
                      SizedBox(height: 20,),
                      Text('本空间长期与内地、香港两地政府、大专院校、青年团体、社福机构等合作开展6期“创新创业青春学堂”。本项目免费为内地与香港创业青年提供两地交流创业平台，大力促进两地青年融洽并推动青年融入粤港湾大湾区建设。', style: TextStyle(color: AppColors.COLOR_2C3340, fontSize: AppFont.SIZE_28)),
                      SizedBox(height: 20,),
                      Container(
                        child: Image.asset(AppImages.COMPANY_IMG_1, width: ScreenUtil().setWidth(690), height: ScreenUtil().setWidth(388)),
                      ),
                      SizedBox(height: 20,),
                      Text('708090创客汇自创办以来，先后获各界政府授予「创新创业孵化基地」、「青年文明号」、「龙岗区创新创业先锋团队」、「十大深港交流合作创业空间」等光荣称号。其举办的6期「创新创业青春学堂」参与人次超过2000人，成功孕育多个项目落地，为两地青年创造商机。', style: TextStyle(color: AppColors.COLOR_2C3340, fontSize: AppFont.SIZE_28)),
                    ],
                  ),
                ),
                SizedBox( height: 15,),
