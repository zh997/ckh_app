    ...
    return FutureBuilder(future: logic.onInitData(), builder: (BuildContext context,  AsyncSnapshot snapshot){
      if (snapshot.connectionState == ConnectionState.done){
        return Scaffold(
            ...
            body: Obx((){
              final List activeList = state.newsList.value;
                ...
                slivers: [
                  ...
                  SliverList(delegate: SliverChildBuilderDelegate((BuildContext context, int index){
                    return GestureDetector(
                      behavior: HitTestBehavior.opaque,
                      onTap: (){
                        Get.toNamed(RouteConfig.active_detail + '?id=${activeList[index].id}&type=2');
                      },
                      child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(activeList[index].updateTime, style: TextStyle(color: AppColors.COLOR_B1B8C7, fontSize: AppFont.SIZE_32,), maxLines: 2, overflow: TextOverflow.ellipsis,),
                                      ],
                                    )
                                  ],
                                ),
