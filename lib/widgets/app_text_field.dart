...
class _RowTextFieldState extends State<RowTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    // 标题
    final title = [
      Text('${widget.title ?? ''}', style: TextStyle(color: AppColors.COLOR_BLACK_333333, fontSize: AppFont.SIZE_28)),
      Container(
        width: 8,
        child: Text('${widget.isRequired ? '*' : ''}', style: TextStyle(color: AppColors.COLOR_PRIMARY_FF733E, fontSize: AppFont.SIZE_28)),
      ),
    ];

    // 下划线
    final bottomLine = BorderSide(width: 1, color: errorText.isNotEmpty ? AppColors.COLOR_PRIMARY_D22315 : AppColors.COLOR_E6E9F0);
        ...
        Expanded(child: Stack(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(widget.labelText, style: TextStyle(fontSize: ScreenUtil().setSp(32), color: AppColors.COLOR_GRAY_CCCCCC)),
            ) : SizedBox(),
            ...
            TextFormField(
              ...
              style: TextStyle(fontSize: ScreenUtil().setSp(40), color: AppColors.COLOR_232933),
              cursorColor: AppColors.COLOR_232933,
    ...
    final uploadBtn = Column(
      ...
      children: [
        Row(
          ...
          children: [
            Icon(Icons.add),
            Text('添加照片', style: TextStyle(color: AppColors.COLOR_BLACK_333333, fontSize: AppFont.SIZE_48))
          ],
        ),
        Text('最多可上传两张', style: TextStyle(color: AppColors.COLOR_GRAY_CCCCCC, fontSize: AppFont.SIZE_42))
      ],
    );
    return Column(
      children: [
