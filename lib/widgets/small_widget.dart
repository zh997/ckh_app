    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Padding(padding: EdgeInsets.only(left: 15, right: 15), child: Text(num.toString(), style: TextStyle(color: AppColors.COLOR_BLACK_000000, fontSize: AppFont.SIZE_46))),
          GestureDetector(
            behavior: HitTestBehavior.opaque,
            onTap: rightTap,
                  ...
                  children: [
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        child: Text('取消', style: TextStyle(fontSize: AppFont.SIZE_48, color: AppColors.COLOR_GRAY_666666)),
                      ),
                    )),
                    ...
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        alignment: Alignment.center,
                        height: ScreenUtil().setWidth(150),
                        child: Text('确定', style: TextStyle(fontSize: AppFont.SIZE_48, color: AppColors.COLOR_PRIMARY_D22315)),
                      ),
                    ))
                  ],
                )
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(child: Container(
      ...
      child: Column(
        ...
        children: [
          Text(text, style: TextStyle(color: AppColors.COLOR_BLACK_333333, fontSize: AppFont.SIZE_48)),
          SizedBox(height: 20),
          PrimaryButton(btnText, width: 400, height: 130, onTap: onTap)
        ],
      ),
    ));
  }}